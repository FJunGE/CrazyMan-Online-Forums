      ...
      <div class="card-body">
        ...
        @endif
          ...
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="form-group">
                    <label for="collection-field">Collection</label>
                    <input class="form-control" type="text" name="collection" id="collection-field" value="{{ old('collection', $topic->collection ) }}" />
                </div> 
                <div class="form-group">
                    <label for="fabulous-field">Fabulous</label>
                    <input class="form-control" type="text" name="fabulous" id="fabulous-field" value="{{ old('fabulous', $topic->fabulous ) }}" />
                </div> 
                <div class="form-group">
                    <label for="forward-field">Forward</label>
                    <input class="form-control" type="text" name="forward" id="forward-field" value="{{ old('forward', $topic->forward ) }}" />
                </div> 
                <div class="form-group">
